...
/// A count as MFC CastItoIShort shows it: "734", "1.23 k", "4.50 M". 1000-based,
/// "0" for <= 0. Suffixes translate under context "Units".
[[nodiscard]] QString formatShortNumber(double count, int decimals = 2);

template <std::integral T>
[[nodiscard]] QString formatShortNumber(T count, int decimals = 2)
{
